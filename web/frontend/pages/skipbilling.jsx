...
export default function SkipBilling(){
    ...
    const [formData, setFormData] = useState({ name: "", email: "", subject: "", catagory: "skip", });
    ...
    function subscriptionDataFetch(){
        loadStartOption(true); 
        fetch( "/api/easy-subscription/settings/notification_mail_settings?catagory=skip" )
        .then((res) => {
            if (res.ok) {
                return res.json();
            }
                        ...
                        <div className="subActive">
                            <div className="subActiveHeadbtns">
                                <div className="subActiveHead">
                                    <h5 className="innerHead">Skip Subscription Billing</h5>
                                    <p className="paragraph"> Sent to customers when subscription is skipped. </p>
                                </div>
