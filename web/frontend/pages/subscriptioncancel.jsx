...
export default function SubscriptionCancel(){
    ...
    const [formData, setFormData] = useState({ name: "", email: "", subject: "", catagory: "status", });
    ...
    function subscriptionDataFetch(){
        loadStartOption(true); 
        fetch( "/api/easy-subscription/settings/notification_mail_settings?catagory=status" )
        .then((res) => {
            if (res.ok) {
                return res.json();
            }
                        ...
                        <div className="subActive">
                            <div className="subActiveHeadbtns">
                                <div className="subActiveHead">
                                    <h5 className="innerHead">Subscription status change</h5>
                                    <p className="paragraph"> Sent to customers when subscription status changes. </p>
                                </div>
                                ...
                                <div className="subActiveFormDiv">
                                    <form id="subActiveForm" onSubmit={(e) => { e.preventDefault(); }} >
                                        <div className="subActiveFormInput">
                                            ...
                                            <label htmlFor="">
                                                Email subject
                                                <input className={ subjectError.status ? "itginputerror" : "" } type="text" value={formData.subject} onChange={(e) => { setFormData({ ...formData, subject: e.target.value, }); }} placeholder="Subscription status changed" name="email" />
