          ...
          <div className={toggleMenu?"itgDashboardPageContent":"itgDashboardPageContent full"}>
            ...
            <div className="itgDashboardPageContentInner">
              <div className="itgDashboardPageContentTitle">
                <h5 className="title">{customerId!=null&&subscriptionId!=null?"Subscription":"Subscription Orders"} {subscriptionId!=null?<>#{subscriptionId}</>:<></>}</h5>
                  ...
                  <>
                    <div className="itgOrderSearch">
                      <div className="itgOrderSearchInput">
                        <input type="text" placeholder="Search by ID, Customer Name, or Customer Email" value={searchValue} onChange={changeSearchValue} name="search" />
