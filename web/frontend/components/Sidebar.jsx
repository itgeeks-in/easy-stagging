            ...
            <div className="itgDashboardPageSidebarInner">
                ...
                <ul className="menu">
                    ...
                    <li>
                        ...
                        {(splitLocation[1]=='settings' || splitLocation[1]=='customerportal' || splitLocation[1]=='notificationSettings' || splitLocation[1]=='WidgetSetting' ||  splitLocation[1]=='tagorder')  ?<>
                            <ul className="submenus">
                                <li>
                    ...
                    <li>
                        <NavLink to="/helpsupport" title="Help Support">
