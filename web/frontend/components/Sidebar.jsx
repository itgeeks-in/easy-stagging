            ...
            <div className="itgDashboardPageSidebarInner">
                ...
                <ul className="menu">
                    ...
                    <li>
                        ...
                        {(splitLocation[1]=='dunning' || splitLocation[1]=='skipbilling' || splitLocation[1]=='subscriptioncancel' || splitLocation[1]=='subscriptionactivation' || splitLocation[1]=='settings' || splitLocation[1]=='customerportal' || splitLocation[1]=='notificationSettings' || splitLocation[1]=='WidgetSetting' ||  splitLocation[1]=='tagorder')  ?<>
                            <ul className="submenus">
                                <li>
                    ...
                    <li>
                        <NavLink to="/helpsupport" title="Support">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-life-buoy"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="4"></circle><line x1="4.93" y1="4.93" x2="9.17" y2="9.17"></line><line x1="14.83" y1="14.83" x2="19.07" y2="19.07"></line><line x1="14.83" y1="9.17" x2="19.07" y2="4.93"></line><line x1="14.83" y1="9.17" x2="18.36" y2="5.64"></line><line x1="4.93" y1="19.07" x2="9.17" y2="14.83"></line></svg>
