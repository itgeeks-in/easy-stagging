...
class SkipSubMail extends Mailable
{
    ...
    if(!empty($data['subscriptionContractId'])){
        ...
        */
        ...
        return $this->subject($subject)->from($from_mail,$from_name)->view('emails.skip');
    }
}
